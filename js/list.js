function add(title) {
  ...
  if (
    myList.some(function (currentTitle) {
    ...
    const btnAddText = document.querySelector("#btn-add .icon-text");
    btnAddText.innerText = "Remove from My List";
